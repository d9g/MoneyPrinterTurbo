...
class TempoInfo:
    ...
    tempo_italian: str  # 意大利语术语: Presto / Andante / Largo ()
...
class AudioFeatures:
    ...
    chorus_segments: List["ChorusSegment"] = field(default_factory=list)  # 高潮段检测 (精选1/2/3)
    style: Optional[StyleInfo] = None  # 风格识别可后续填入
    id3_metadata: Optional["ID3Metadata"] = None  # 歌曲指纹第一层 (v2-7 新增)
